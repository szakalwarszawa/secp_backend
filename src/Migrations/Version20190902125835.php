...
final class Version20190902125835 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql(
            <<<SQL
            CREATE TABLE "user_work_schedule_logs" (id INT NOT NULL, user_work_schedule_id INTEGER NOT NULL, owner_id
...
SQL
        ...
        $this->addSql(
            <<<SQL
            CREATE INDEX idx_user_work_schedule_user_work_schedule_log_date ON "user_work_schedule_logs" 
            (user_work_schedule_id, log_date)
SQL
        );
        $this->addSql(
            <<<SQL
            ALTER TABLE "user_work_schedule_logs" ADD CONSTRAINT FK_FC5E79C8C6DF60CB FOREIGN KEY 
            (user_work_schedule_id) REFERENCES "user_work_schedules" (id) NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(
            <<<SQL
            ALTER TABLE "user_work_schedule_logs" ADD CONSTRAINT FK_FC5E79C87E3C61F9 FOREIGN KEY (owner_id) REFERENCES
