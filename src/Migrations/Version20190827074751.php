...
final class Version20190827074751 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "property_based_roles" (id INT NOT NULL, ldap_value VARCHAR(255) DEFAULT NULL, framework_value VARCHAR(255) NOT NULL, overridable BOOLEAN NOT NULL, based_on VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX idx_property_based_roles_ldap_value ON "property_based_roles" (ldap_value)');
        $this->addSql('CREATE INDEX idx_property_based_roles_framework_value ON "property_based_roles" (framework_value)');
