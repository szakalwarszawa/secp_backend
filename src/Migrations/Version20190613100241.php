...
final class Version20190613100241 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "work_schedule_profiles" (id INT NOT NULL, name VARCHAR(255) NOT NULL, notice VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
...
SQL
        ...
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E9691648CC FOREIGN KEY (default_work_schedule_profile_id) REFERENCES "work_schedule_profiles" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
