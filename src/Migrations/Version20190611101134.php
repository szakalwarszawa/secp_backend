...
SQL
        ...
        $this->addSql(
            <<<SQL
CREATE TABLE "day_definition_logs" (
    id INT NOT NULL,
...
SQL
        ...
        $this->addSql(
            <<<SQL
CREATE INDEX idx_day_definitions_day_definition_log_date
    ON "day_definition_logs" (day_definition_id, log_date)
SQL
        );
        $this->addSql('COMMENT ON COLUMN "day_definition_logs".log_date IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql(
            <<<SQL
ALTER TABLE "day_definition_logs"
    ADD CONSTRAINT FK_A126FF9F81F0C051
...
SQL
        ...
        $this->addSql(
            <<<SQL
ALTER TABLE "day_definition_logs"
    ADD CONSTRAINT FK_A126FF9F7E3C61F9
