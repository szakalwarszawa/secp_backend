...
final class Version20190826135609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_user_timesheet_day_log_log_date ON "logs"."user_timesheet_day_logs" 
        (user_timesheet_day_id, log_date)');
        $this->addSql('ALTER TABLE "logs"."user_timesheet_day_logs" ADD CONSTRAINT FK_657E6C545B30FBB2 FOREIGN KEY 
        (user_timesheet_day_id) REFERENCES "user_timesheet_days" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE "logs"."user_timesheet_day_logs" ADD CONSTRAINT FK_657E6C547E3C61F9 FOREIGN KEY
