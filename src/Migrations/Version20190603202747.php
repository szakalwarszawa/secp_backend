...
final class Version20190603202747 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "sections" (id INT NOT NULL, department_id INT NOT NULL, name VARCHAR(255) NOT NULL, active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE section_managers (section_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(section_id, user_id))');
        ...
        $this->addSql('CREATE TABLE "departments" (id INT NOT NULL, name VARCHAR(255) NOT NULL, short_name VARCHAR(255) NOT NULL, active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE department_managers (department_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(department_id, user_id))');
        ...
        $this->addSql('ALTER TABLE "sections" ADD CONSTRAINT FK_2B964398AE80F5DF FOREIGN KEY (department_id) REFERENCES "departments" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE section_managers ADD CONSTRAINT FK_3924BA5AD823E37A FOREIGN KEY (section_id) REFERENCES "sections" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE section_managers ADD CONSTRAINT FK_3924BA5AA76ED395 FOREIGN KEY (user_id) REFERENCES "users" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE department_managers ADD CONSTRAINT FK_90F7FA2CAE80F5DF FOREIGN KEY (department_id) REFERENCES "departments" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE department_managers ADD CONSTRAINT FK_90F7FA2CA76ED395 FOREIGN KEY (user_id) REFERENCES "users" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
