...
ALTER TABLE "sections" 
    ADD CONSTRAINT FK_2B964398AE80F5DF
    FOREIGN KEY (department_id)
    REFERENCES "departments" (id) NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(
            <<<SQL
ALTER TABLE section_managers
    ADD CONSTRAINT FK_3924BA5AD823E37A
    FOREIGN KEY (section_id)
    REFERENCES "sections" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(
            <<<SQL
ALTER TABLE section_managers
    ADD CONSTRAINT FK_3924BA5AA76ED395
    FOREIGN KEY (user_id)
...
ALTER TABLE department_managers
    ADD CONSTRAINT FK_90F7FA2CAE80F5DF
    FOREIGN KEY (department_id)
    REFERENCES "departments" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(
            <<<SQL
ALTER TABLE department_managers
    ADD CONSTRAINT FK_90F7FA2CA76ED395
    FOREIGN KEY (user_id)
    REFERENCES "users" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        ...
        $this->addSql(
            <<<SQL
ALTER TABLE users
    ADD CONSTRAINT FK_1483A5E9AE80F5DF
    FOREIGN KEY (department_id)
    REFERENCES "departments" (id) NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(
            <<<SQL
ALTER TABLE users
    ADD CONSTRAINT FK_1483A5E9D823E37A
    FOREIGN KEY (section_id)
    REFERENCES "sections" (id) NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
